/*
package com.aait.ezak.ui.fragments.testFragments
...
import com.aait.ezak.R
import com.aait.ezak.base.BaseFragment
import com.aait.ezak.fcm.MessageService
import com.aait.ezak.listeners.OnBack
import com.aait.ezak.models.captin_model.Data
import com.aait.ezak.models.client_later_model.Reason
import com.aait.ezak.network.remote_db.SocketConnection
import com.aait.ezak.ui.dialogs.RateDialog
import com.aait.ezak.utils.*
import com.aait.ezak.utils.MapUtils.getDirectionPolylines
...
class TrackingFragment : BaseFragment() , OnMapReadyCallback,
    ...
    companion object{
        ...
        private var mData: com.aait.ezak.models.order_details_model.Data?=null
    }
    ...
    private fun showRatingDialog(data: com.aait.ezak.models.order_details_model.Data) {
        RateDialog(data,{
            sendRequestRate(it)
        }) {
            isEnableToBack=true
