...
import com.aait.ezakbus.GPS.GPSTracker
import com.aait.ezakbus.GPS.GPSTrakerListner
...
class MapActivity : ParentActivity(), OnMapReadyCallback,
    ...
    private fun showLocation() {
        ...
        val location = GPSTracker(this, object : GPSTrakerListner {
            override fun onTrakerSuccess(lat: Double?, log: Double?) {}

            override fun onStartTraker() {

                avi.show()
            }

            override fun onStopTracker(lat: Double, lng: Double) {
                avi.hide()
                addMarker(lat, lng)
